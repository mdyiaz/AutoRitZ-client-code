...
<div className="modal">
  <div className="modal-box relative">
    ...
    <h3 className="text-xl text-amber-700 font-bold">{buyElectricCar.name}</h3>
   ...
   <form className='grid grid-cols-1 gap-3 mt-5' onSubmit={handleBooking}>
            ...
            <input name='price' type="text" className="input input-bordered w-full  " value={buyElectricCar.price} disabled />
